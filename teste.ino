...
void loop() 
{
  ...
  else if (/* Condição para detectar o oponente */ false) {
    moveToOponent();
  } 
  else {
    searchMethod();
...
// TODO: Defina os movimentos do robô ao encontrar a linha branca
void inWhiteLine() {}

// TODO: Defina os movimentos do robô ao detectar o adversário
void moveToOponent() {}

// TODO: Defina o padrão de busca do robô enquanto não encontra nada
void searchMethod() {}
