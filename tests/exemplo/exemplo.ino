/*
 * =====================================================================================
 *                    EXEMPLO - ROBÔ DE SUMÔ (baseado em src/main.ino)
 * =====================================================================================
 *
 * Sketch de inspiração. Antes de usar na luta, calibrar com a verificação dos sensores:
 *   - 'line' e a comparação dentro de ehBranco()
 *   - 'threshold'
 *   - 'tempoRe' e 'tempoGiro'
 * =====================================================================================
 */
...
int threshold = 500; // Acima deste valor o Sharp está vendo o oponente
int line = 700;      // Limite entre preto e branco (ver ehBranco)

// Tempos das manobras na borda, em milissegundos
int tempoRe = 300;
int tempoGiro = 400;
...
void loop()
{
  ...
  // -----------------------------------------------------------------------------------
  // CONTROLE DO ROBÔ E REGRA DOS 5 SEGUNDOS
  // -----------------------------------------------------------------------------------
  receptorIR();
